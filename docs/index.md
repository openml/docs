...
<h1>OpenML builds a seamless, open ecosystem of machine learning data, models, and benchmarks - advancing AI openly for the benefit of all humanity.</h1>

:fontawesome-solid-layer-group: </i><a href="https://www.openml.org/search?type=data" target="_blank">&nbsp; 1000s of data sets</a>, uniformly formatted, easy to load and organized online
